...
public abstract class SqlGen {
	// DDL
	protected abstract PreparedStatement getCreateTable(Connection con, Object obj);
	protected abstract PreparedStatement getDropTable(Connection con, Object obj);
	// DML
